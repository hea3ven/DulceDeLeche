...
public enum Metal implements IStringSerializable {
	IRON(ToolMaterial.IRON, ArmorMaterial.IRON, (216 << 16) + (216 << 8) + 216, "oreIron", "blockIron",
			"ingotIron", "nuggetIron", 0, 64),
	COPPER(null, null, (210 << 16) + (80 << 8) + 50, "oreCopper", "blockCopper", "ingotCopper",
			"nuggetCopper", 32, 64),
	TIN(null, null, (185 << 16) + (210 << 8) + 230, "oreTin", "blockTin", "ingotTin", "nuggetTin", 58, 90),
	...
	BRONZE(EnumHelper.addToolMaterial("bronze", 1, 1024, 6.0F, 2.0F, 16),
			...
			(225 << 16) + (170 << 8) + 80, null, "blockBronze", "ingotBronze", "nuggetBronze", 0, 0),
	...
	COBALT(EnumHelper.addToolMaterial("cobalt", 3, 2048, 9.0F, 4.0F, 14),
			...
			(65 << 16) + (90 << 8) + 205, "oreCobalt", "blockCobalt", "ingotCobalt", "nuggetCobalt", 0, 0),
